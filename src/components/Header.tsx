...
const Header: React.FC<HeaderTypes["IProps"]> = ({ addNewList }) => {
  return (
    <div className="drop-shadow-md flex flex-col items-center overflow-visible justify-end bg-gradient-to-r from-myBlue to-myPink bg-opacity-10 h-32 p-5 text-white">
